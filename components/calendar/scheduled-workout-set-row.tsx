...
export type ScheduledWorkoutSetRowHandle = { focus: () => void };
...
export const ScheduledWorkoutSetRow = memo(
  forwardRef<ScheduledWorkoutSetRowHandle, Props>(function ScheduledWorkoutSetRow(
    { set, setNumber, measurementType, exerciseName, onDelete }: Props,
    ref,
  ) {
