...
const styles = StyleSheet.create({
  ...
  info: { flex: 1, gap: 2 },
  title: { fontSize: 15, fontWeight: '600', color: Colors.light.textPrimary },
  summary: { fontSize: 13, color: Colors.light.textMuted },
  next: { fontSize: 11, color: Colors.light.textPlaceholder },
  ...
  actionBtnText: { fontSize: 12, color: Colors.light.textBody, fontWeight: '500' },
