...
const styles = StyleSheet.create({
  ...
  errorText: { fontSize: 12, color: Colors.light.danger, marginBottom: 4 },
  input: {
    borderWidth: 1,
  ...
  timeButtonText: { fontSize: 28, fontWeight: '700', color: Colors.light.textPrimary, letterSpacing: 2 },
  ...
  chipTextActive: { color: Colors.light.onAccent, fontWeight: '600' },
  ...
  wdChipText: { fontSize: 13, color: Colors.light.textSecondary },
  ...
  mdChipEom: { width: 52 },
  mdChipText: { fontSize: 12, color: Colors.light.textSecondary },
  ...
  stepperBtnText: { fontSize: 20, color: Colors.light.accent, lineHeight: 22 },
  stepperNum: { fontSize: 16, fontWeight: '600', color: Colors.light.textPrimary, minWidth: 100, textAlign: 'center' },

  buttons: { flexDirection: 'row', gap: 12, marginTop: 20 },
  cancelBtn: { flex: 1, padding: 12, borderRadius: 10, backgroundColor: Colors.light.border, alignItems: 'center' },
  cancelBtnText: { fontSize: 15, color: Colors.light.textSecondary, fontWeight: '600' },
  submitBtn: { flex: 1, padding: 12, borderRadius: 10, backgroundColor: Colors.light.accent, alignItems: 'center' },
  submitBtnDisabled: { backgroundColor: Colors.light.textPlaceholder },
  submitBtnText: { fontSize: 15, color: Colors.light.onAccent, fontWeight: '600' },
});
